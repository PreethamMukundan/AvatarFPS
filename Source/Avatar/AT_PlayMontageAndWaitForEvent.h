...
class UBaseChar_AbilitySystemComponent;
...
UCLASS()
class AVATAR_API UAT_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
public:
...
private:
	...
	UBaseChar_AbilitySystemComponent* GetTargetASC();
